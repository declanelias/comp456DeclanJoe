...
With this rise in popularity has come a rise in data and analysis. Everywhere you look in the online gambling world there are people trying to sell their picks, claiming that they have an algorithm that can beat the lines set by Vegas. But the books know what they're doing. 
...
![](graphics/pinnacle.png)

</center>

<center>

![](graphics/army_navy_fanduel.png)
...
all_sports_ml %>%
  ...
  facet_wrap(~league) + 
  theme_bw() +
  labs(x = "Brier Score", y = "Count", title = "Distribution of Books When Compared To The Average")
