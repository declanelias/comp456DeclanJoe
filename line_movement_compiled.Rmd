...
load("NFL_2018_movement_df.rdata")
load("NFL_2020_movement_df.rdata")
load("NFL_movement_2016_df.rdata")
load("NFL_movement_2015_df.rdata")
load("NFL_movement_2014_df.rdata")
load("NFL_movement_2013_df.rdata")
load("NFL_movement_2012_df.rdata")
```
...
NFL_movement_df <- NFL_movement_df %>%
  rbind(NFL_movement_2016_df) 

NFL_movement_df <- NFL_movement_df %>%
  rbind(NFL_movement_2015_df) 

NFL_movement_df <- NFL_movement_df %>%
  rbind(NFL_movement_2014_df) 

NFL_movement_df <- NFL_movement_df %>%
  rbind(NFL_movement_2013_df) 

NFL_movement_df <- NFL_movement_df %>%
  rbind(NFL_movement_2012_df) 
...
```{r}
save(NFL_lines_split, file = "NFL_movement_split_df.rdata")
save(NCAAF_lines_split, file = "NCAAF_movement_split_df.rdata")
save(MLB_lines_split, file = "MLB_movement_split_df.rdata")
save(NBA_lines_split, file = "NBA_movement_split_df.rdata")
save(NHL_lines_split, file = "NHL_movement_split_df.rdata")
```
