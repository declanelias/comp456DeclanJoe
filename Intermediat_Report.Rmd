...
grid.arrange(create_ml_prob_hist("mlb"),
             create_ml_prob_hist("nba"),
             create_ml_prob_hist("ncaab"),
             create_ml_prob_hist("nhl"),
             create_ml_prob_hist("nfl"),
             create_ml_prob_hist("ncaaf"),
             nrow = 3)
```
...
ml_data_all %>%
  ...
  mutate(winning_team_prob = if_else(home_team_win, ml_home_implied_prob, ml_away_implied_prob),
         losing_team_prob = if_else(home_team_win, ml_away_implied_prob, ml_home_implied_prob)) %>%
  ggplot(aes(x = winning_team_prob)) +
  geom_density(adjust=3, color = "green") +
  geom_density(aes(x = losing_team_prob), adjust=3, color = "red") +
  theme_minimal()
```

This plot shows the densities of win / loss probabilities for the best performing and worst performing books (60 and 55 respectively).
