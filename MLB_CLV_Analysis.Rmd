...
# Recipe
logistic_rec <- recipe(make_bet ~ money_line + spread + total + team_total + Location + book_id, data = MLB_Full, family = binomial('logit'), maxit = 100) %>%
...
data_rec <- recipe(make_bet ~ money_line + spread + total + team_total + Location + book_id, data = MLB_Full)
